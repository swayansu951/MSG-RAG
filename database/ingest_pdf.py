...
from semantic_graph.graph_structure import table_to_graph, update_all_node_confidences
from ingestion.table_detection import TableDetector, TableType
from ingestion.graph_storage import save_graphs

# def proecss_tables_in_pdf(pdf_path, doc_id):
